...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import NUMA_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("7f51dc2b-bb24-59f8-b771-bb1490e4195d"))
platforms = [Pkg.Artifacts.unpack_platform(e, "NUMA", artifacts_toml) for e in artifacts["NUMA"]]
...
if best_platform === nothing
    @debug("Unable to load NUMA; unsupported platform $(triplet(platform_key_abi()))")
else
